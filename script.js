...
let api_key = '715c6259dcf63a1e194a8bd525dcc369';  // Api key generada en nuestro registro
let urlBase = 'https://api.themoviedb.org/3/search/movie'; // Url para acceder a las peliculas
let urlImg = 'http://image.tmdb.org/t/p/w200'  // Url pára permitirnos visualizar la imagen de cada pelicula en la lista

// https://api.themoviedb.org/3/search/movie?query=Jack+Reacher&api_key=715c6259dcf63a1e194a8bd525dcc369
